...
import {STORAGE_TEMP_ADDRESS, LOCAL_CARTS} from '../../../util/AppConstant'
...
class Checkout extends Component {
    ...
    placeOrder(cartItems) {
        ...
        let orderNumber = helpers.makeRandomNumeric(9);
            ...
            response => {
                ...
                if (orderItems.length) {
                    ...
                    response2 => {
                        ...
                        // Clear Local Storage of Carts
                        localStorage.removeItem(LOCAL_CARTS)

                        // Go to Success page
                        this.props.router.push(`/order/checkout/success?OrderNumber=${orderNumber}`)
                    },
                    error2 => {
    ...
    render() {
        ...
        if (this.props.user.cartItems && this.props.user.cartItems.length) {
